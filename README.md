...
## Sobre o projeto
O projeto é uma aplicação simples de cadastros de categorias e produtos utiliazando ajax na área de cadastro de produtos. A finalidade é mostrar as habilidade em criação de Migrations, Controllers e Views do framework Laravel para que seja feito um CRUD.
